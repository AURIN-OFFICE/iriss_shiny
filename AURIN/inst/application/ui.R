...
ui <- fluidPage(theme = shinytheme("sandstone"),navbarPage(id = "inTabset",
  title = tags$img(src = "logo.png",height = 30, width = 130,align = "center"),   
  position = c("fixed-top"),
  tabsetPanel(type = "tabs",
    tabPanel(tags$h5('Home'),value = "home",  uiOutput("Tab_home",align="center"), ),
    ...
    tabPanel('', value = "success", uiOutput("success",align="center")),id = "tabselected"),
