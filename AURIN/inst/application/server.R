...
server = shinyServer(function(input, output, session) {
  ...
  output$home  = renderUI(fluidRow(div(style='width: 100%; height: 1000px; overflow: hidden; position: relative;',
    ...
    fluidRow(column(6,CreateBox(color = '#96B243',id='subbox16',height= "calc(40vh)",left='3',right='3',
    ...
    column(6,CreateBox(color = '#96B243',id='subbox15',height= "calc(40vh)",left='3',right='3',
    ...
    div(CreateBox(color = '#45A0EF',id='subbox1s',height= "calc(40vh)",left='3',right='3',
  ...
  output$users  = renderUI(fluidRow(div(style='width: 100%; height: 1000px; overflow: hidden; position: relative;',
    ...
    fluidRow(column(6,CreateBox(color = '#96B243',id='s',height= "calc(70vh)",left='3',right='3',
    ...
    ButtonContent(buttonAction(outputId='guided_linkage', label='Select',color = "#799d0d"))))),
    column(6,CreateBox(color = '#ed8333',id='s',height= "calc(70vh)",left='3',right='3',
    content=tagList(div(style="font-size: 20px; padding-left: 5%; padding-right: 5%;color: white; font-family: Arial; overflow-y:hidden;",
    ...
    ButtonContent(buttonAction(outputId='self_linkage', label='Select',color = "#eb6601")))))),
    HTML('<br>'),
  ...
  output$parameters <- renderUI(
    ...
    renderUI(fluidPage(shinydashboard::box(width = 1000,height = 1000,status = "success",solidHeader = T,
    ...
    column(6,CreateBox(color = '#dde6cd',id='subbox10',height= "calc(27vh)",left='-3',right='-1',content=centerContentLinks(fluidPage(fluidRow( tags$h3('Survey data documentation',style='color: black;font-weight: bold;',style='color: black;font-weight: bold; text-decoration: underline;')),
    fluidRow( tags$a(target="_blank",
    href="https://www.lsay.edu.au/data/access","• How to access LSAY data",style='text-decoration: underline;')),
    fluidRow( tags$a(target="_blank",
    href="https://www.lsay.edu.au/publications/search-for-lsay-publications/2547","• LSAY 2009 cohort user guide",style='text-decoration: underline;')),
    fluidRow(tags$a(target="_blank",
    href="https://www.lsay.edu.au/publications/search-for-lsay-publications/2621", "• LSAY variable listing and metadata",style='text-decoration: underline;')),
    fluidRow(tags$a(target="_blank",
    href="https://www.lsay.edu.au/publications/search/y09-questionnaires-and-frequency-tables", "• LSAY 2009 cohort questionnaires and frequency tables",style='text-decoration: underline;'))))))),
    fluidRow(column(12,HTML("<br>"))),
    fluidRow(column(6,fluidRow(column(4,pickerInput(inputId = "TSP",label = "DataPack", choices = TSP_choices, options = pickerOptions(actionsBox = TRUE,liveSearch=TRUE,showTick=TRUE,virtualScroll=TRUE,tickIcon='glyphicon glyphicon-ok',title = "Select more than one",header = "Years of the merge" ,style = "btn-light"))),
    ...
    column(6,CreateBox(color = '#c9cee8',id='subbox11',height= "calc(27vh)",left='-3',right='-1',content=centerContentLinks(fluidPage(fluidRow( tags$h3('Geospatial data documentation',style='color: black;font-weight: bold;text-decoration: underline;')),
    fluidRow( tags$a(target="_blank",
    href="https://www.abs.gov.au/census/2021-census-data-release-plans/2021-census-product-release-guide#datapacks","• ABS DataPacks",style='text-decoration: underline;')),
    fluidRow(tags$a(target="_blank",
    href="https://www.abs.gov.au/census/guide-census-data/geography", "• Understanding Census geography",style='text-decoration: underline;')),
    fluidRow(tags$a(target="_blank",
    href="https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/main-structure-and-greater-capital-city-statistical-areas/statistical-area-level-3", "• ASGS SA3s",style='text-decoration: underline;')),
    fluidRow(tags$a(target="_blank",
    href="https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/correspondences", "• Geographic correspondences",style='text-decoration: underline;'))))))))
    ,HTML('<br><br><br><br>'),
    fluidRow(
  ...
  output$success <- renderUI(
    ...
    fluidRow(column(12,CreateBox(color = '#dde6cd',id='subbox5',height= "calc(50vh)",left='-1',right='-1',
    ...
    column(3,align="center",div(style='font-size: 20px; color: #759aaf; font-family: Arial;',
    ...
    HTML('<br><br><br>'),
    fluidRow(column(4,ButtonContent(buttonAction(outputId='back_success', label='Back',color = "#759AAF"))),column(8,""))))))))
  ...
  output$resources <- renderUI( tagList(HTML('<br><br><br>'),div(style="position:absolute; padding-left: 0.5%; color: '#434349'; font-family: Arial;",tags$h2(HTML("<b>Resources</b> "))),HTML('<br><br><br>'),
    ...
    fluidRow(
    column(4,CreateBox(color = '#91ae3b',id='subbox1s',height= "calc(50vh)",left='-1',right='-3',content=centerContent(tagList(fluidRow(column(12,HTML("TOOLBOX"),HTML('<br>'))),
    ...
    column(4,CreateBox(color = '#005baa',id='subbox2s',height= "calc(50vh)",left='-1',right='-3',
    ...
    column(4,CreateBox(color = '#5c7e92',id='subbox3s',height= "calc(50vh)",left='-1',right='-3',
    ...
    HTML('<br>'),
    fluidRow(column(12,buttonDownload(outputId = "parameters_format",label = "Download",color = "#445d6c"))),
    )))))))),
    HTML("<br>"),
    fluidRow(column(12,CreateBox(color = '#e1b82e',id='subbox4s',height= "100%",left='-1',right='-1',
  ...
  ###### -------- Action to guided linkage ----- ###### 
  observeEvent(input$guided_linkage, {
    ##### ------ Restart values pickers -------- #########
  ...
  ###### -------- Action to guided linkage ----- ###### 
  observeEvent(input$self_linkage, {
    updateTabsetPanel(session, "tabselected",
                      selected = "resources")
  })
  
  ###### -------- Action to data cloud ----- ###### 
  ...
  observeEvent(input$continue_ada, {
    #### ----- Validate that the user put a token -- -###
    if(input$token_ada==''){
  ...
  observeEvent(input$continue_local, {
    #### ----- Validate that the user put a path -- -###
    if(input$path_files==''){
  ...
  ###### -------- Back home from user profile----- ###### 
  observeEvent(input$back_home, {
    updateTabsetPanel(session, "tabselected",
                      selected = "home")
  })
  
  ###### -------- Back from users profile ----- ###### 
  ...
  ###### -------- Back from api to data----- ###### 
  observeEvent(input$back_ada, {
    updateTabsetPanel(session, "tabselected",
                      selected = "data")
  })
  
  ###### -------- Back from local to data----- ###### 
  observeEvent(input$back_local, {
    updateTabsetPanel(session, "tabselected",
                      selected = "data")
  })
  
  ###### -------- Back from success to data ----- ###### 
  observeEvent(input$back_success, {
    updateTabsetPanel(session, "tabselected",
                      selected = "data")
  })
  
  ###### -------- Back from self-guided to user profile ----- ###### 
  ...
  ###### ------- Function that consolidate all the results into the zip folder ----- #########
  output$Report = downloadHandler(
    ...
    content = function(file) {
      ...
      ###### --------- Create a parameters file based on the user input ------ ######
      write(CreateParameters(input$token_ada, 
                             input$path_files ,
                             input$longitudinal, 
                             input$long_waves, 
                             input$long_topic, 
                             input$TSP, 
                             input$TSP_years, 
                             input$TSP_variables), paste0(relativepath,"/parameters.json"))
      ...
      ###### -------- Define the temporal folder as main folder ----- ######
      setwd(relativepath)
      ##### ------ Create a zip with all the content ----- ###### 
  ...
  ###### -------- Download Parameters ------ #####
  output$parameters_format <- downloadHandler(
